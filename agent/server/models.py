...
class MessageItem(BaseModel):
    ...
    message_format_version: Optional[int] = None
...
class UploadFolderLocalRequest(BaseModel):
    session_id: str
    project_id: Optional[str] = None
    folder_path: str
    conflict_strategy: Optional[Literal["replace", "rename"]] = None


class UploadFolderLocalResponse(BaseModel):
    imported_count: int
    failed_count: int
...
class UploadConflictsCheckRequest(BaseModel):
    session_id: str
    project_id: Optional[str] = None
    relative_paths: List[str]


class UploadConflictsCheckResponse(BaseModel):
    has_conflicts: bool
